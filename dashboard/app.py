...
# --- Import Core Logic ---
# (We use try-except to handle path differences between local and cloud)
try:
    ...
    # Fallback for direct execution if paths get mixed up
    import sys
    import os
...
with tab3:
    ...
    with st.expander("See Regression Equation"):
        ...
        """)
        st.write("Where $\epsilon$ represents market volatility noise modeled by the system.")
